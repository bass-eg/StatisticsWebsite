...
function dselect(el, option = {}) {
  ...
  const searchInput = search
    ? `<input onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control" placeholder="إبحث" autofocus>`
    : "";
    ...
    <div class="dropdown ${classElement} ${additionalClass}">
      ...
      <div class="dropdown-menu">
        <div class="d-flex flex-column">
          ...
          <div class="${classNoResults} d-none">لا يوجد نتائج.</div>
        </div>
      </div>
      ${clearBtn}
    </div>
