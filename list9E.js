...
function drawCharts(Objects) {
  ...
  let name1 = [
    arabicTranslation[0].list9E.originalVolume,
    arabicTranslation[0].list9E.remainingVolume,
    arabicTranslation[0].list9E.percentageRemaining,
  ];
  Objects.map((el) => {
    date.push(el.date);
    originalVolume.push(el.originalVolume);
    remainingVolume.push(el.remainingVolume);
    percentageRemaining.push(el.percentageRemaining);
  });
  let data1 = [];
  data1.push(
    {
      ...
      name: name1[0],
      type: "bar",
      hovertemplate: `%{x} :${arabicTranslation[0].list9E.date}<br>%{y} :${arabicTranslation[0].list9E.originalVolume}<br>`,
    },
    {
      x: date,
      y: remainingVolume,
      ...
      hovertemplate: `%{x} :${arabicTranslation[0].list9E.date}<br>%{y} :${arabicTranslation[0].list9E.remainingVolume}<br>%{customdata}% :${arabicTranslation[0].list9E.percentageRemaining}`,
    }
  );
