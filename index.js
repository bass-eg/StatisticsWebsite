...
let noDataMsg = {
  ...
  list9F:
    "<h3>هذه القضية لا تحتوي على الإحصائيات الخاصة بعدد الأوامر الملغاةالمنفذة</h3>",
  list10:
    "<h3>هذه القضية لا تحتوي على الإحصائيات الخاصة بالمعدل التراكمي لحجم وقيمة الشراءالبيع</h3>",
  list11:
