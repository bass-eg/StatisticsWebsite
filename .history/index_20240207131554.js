...
const navLinks = [
  { link: "list1A.html", pagename: "تزامن المخالفات" },
  { link: "list1B.html", pagename: "تزامن عمليات التداول" },
  { link: "list1C.html", pagename: "نشاط التداول" },
  { link: "list2.html",  pagename: "نسبة الملكية" },
  { link: "list4.html",  pagename: "نسبة الأوامر" },
  { link: "list5.html",  pagename: "عدد الأوامر" },
  { link: "list6.html",  pagename: "قيمة المحفظة في اليوم" },
  { link: "list7.html",  pagename: "مجموع التداولات" },
  { link: "list9A.html", pagename: "إجمالي ونسبة التداولات" },
  { link: "list9B.html", pagename: "متوسط سعر التنفيذ" },
  { link: "list9C.html", pagename: "الأسعار قبل، بعد و خلال المخالفة" },
  { link: "list9D.html", pagename: "عدد الصفقات المتقابلة" },
  { link: "list9E.html", pagename: "نسبة الأسهم المتبقية/المدخلة" },
  { link: "list9F.html", pagename: "نسبة الأوامر الملغاة/المنفذة<" },
  { link: "list10.html", pagename: "المعدل التراكمي لحجم وقيمة الشراء/البيع" },
  { link: "list11.html", pagename: "أداء السهم بحركة المؤشر<" },
  { link: "list8.html",  pagename: "التشابه في الIP address</address>" },
  { link: "list3.html",  pagename: "العلاقات بين المشتبه بيهم<" },
];
