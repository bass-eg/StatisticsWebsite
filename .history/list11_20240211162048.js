...
function updateCharts(chartsData, startDate = null, endDate = null) {
  ...
  if (
    ...
    console.log("chartsData.securities is ", chartsData.securities);
    console.log("$("#selectCompany").val() is ", chartsData.securities);
    // let result2 = customFilter.filterByMultiSector(
    //   chartsData.sectors,
    //   $("#selectSector").val()
    // );

    console.log("res from securities are ", result);
    // console.log("res2 from sectors are ", result2);
