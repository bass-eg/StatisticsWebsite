...
function drawCharts(Objects, selectedItems) {
  ...
  console.log("Objects in list1B are ", Objects);
  ...
  selectedItems.map((el) => {
    selectedItemsObjects.push({
      ...
      type: selectedType,
      hovertemplate: `%{x} :${arabicTranslation.securityName}<br>%{y} :${arabicTranslation[el]}<br>`,
    });
  });
  let data1 = [];
...
function updateCharts(chartsData) {
  ...
  if (
    ...
    console.log("selectedCompanyObj in list1B is ", selectedCompanyObj);
