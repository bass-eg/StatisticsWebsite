    ...
    el.map((inner) => {
      inner.details
        .filter((a) => {
          ...
          console.log("startDateDate is ", startDateDate);
          console.log("endDateDate is ", endDateDate);
          console.log(
            "(!startDate || date >= startDate) && (!endDate || date <= endDate) is ",
            (!startDate || date >= startDateDate) &&
              (!endDate || date <= endDateDate)
          );
          return (
