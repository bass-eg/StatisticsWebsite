...
function drawCharts(Objects, selectedItems) {
  ...
  console.log("inside   if (Object.keys(Objects).length !== 1) ");
...
function drawEmptyCharts(Objects, selectedItems) {
  console.log("Objects are ", Objects);
  console.log("inside   if (Object.keys(Objects).length !== 1) ");
  let selectedType = $("#selectedType").val();
  if (selectedType != "scatter" && selectedType != "bar") {
...
function updateCharts(chartsData) {
  ...
  if (
    ...
    if (
      ...
      console.log("inside emptyObj");
      drawEmptyCharts(emptyObj, selectChartItemsValue);
      helperFunctions.hidePrintContainer();
    } else {
      $("#shape-selection").css({
