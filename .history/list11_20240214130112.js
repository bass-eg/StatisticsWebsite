...
function updateCharts(chartsData) {
  ...
  if (
    ...
    if (
      ...
      $("#globalDownload").removeClass("btn-primary globalDownload");
      $("#globalDownload").addClass("btn-disabled globalDownload");
    } else {
      $("#shape-selection").css({
      ...
      console.log("data");
      $("#globalDownload").removeClass("btn-disabled globalDownload");
      $("#globalDownload").addClass("btn-primary globalDownload");
