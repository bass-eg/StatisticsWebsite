...
import tablesStructures from "./tablesStructures.js";
...
const startProgram = async () => {
  ...
  if (isPageListExist) {
    ...
    const currentTableStructure = tablesStructures[listName];
    console.log("currentTableStructure is ", currentTableStructure);
    let columnArray = constructDataTable(currentTableStructure);
    console.log(
      "constructDataTable(currentTableStructure) are ",
      constructDataTable(currentTableStructure)
    );
    console.log(
      "!fetchedDatatableData[0][listName] is ",
      !fetchedDatatableData[0][listName]
    );
    console.log("!chartsData[0][listName] is ", !chartsData[0][listName]);
    if (!fetchedDatatableData[0][listName] && !chartsData[0][listName]) {
