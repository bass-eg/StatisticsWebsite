...
const startProgram = async () => {
  ...
  console.log("Object.keys(listFiles) is ", Object.keys(listFiles));

  let isPageListExist = Object.keys(listFiles).find((list) => list == listName);
  console.log("isPageListExist is ", isPageListExist);
  if (isPageListExist) {
