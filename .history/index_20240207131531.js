...
const navLinks = [
  ...
  { link: "list9A.html", name: "إجمالي ونسبة التداولات" },
  { link: "list9B.html", name: "متوسط سعر التنفيذ" },
  { link: "list9C.html", name: "الأسعار قبل، بعد و خلال المخالفة" },
  { link: "list9D.html", name: "عدد الصفقات المتقابلة" },
  { link: "list9E.html", name: "نسبة الأسهم المتبقية/المدخلة" },
  { link: "list9F.html", name: "نسبة الأوامر الملغاة/المنفذة<" },
  { link: "list10.html", name: "المعدل التراكمي لحجم وقيمة الشراء/البيع" },
  { link: "list11.html", name: "أداء السهم بحركة المؤشر<" },
  { link: "list8.html", name: "التشابه في الIP address</address>" },
  { link: "list3.html", name: "العلاقات بين المشتبه بيهم<" },
];
