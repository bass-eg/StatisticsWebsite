...
function prepareDataForCharts(Objects) {
  ...
  Objects.map((el) => {
    el.map((inner) => {
      console.log("inner.details before is ", inner?.details);
      console.log("inner.details.length before is ", inner?.details?.length);
      inner.details
      .filter((a) => {
        var date = new Date(a.date);
          startDate = new Date(startDate);
          endDate = new Date(endDate);
        console.log((!startDate || date >= startDate) && (!endDate || date <= endDate));
          return (
      ...
      console.log("inner.details after is ", inner?.details);
      console.log("inner.details.length after is ", inner?.details?.length);
