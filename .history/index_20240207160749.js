...
import { tablesData } from "./tablesStructure.js";
...
const startProgram = async () => {
  ...
  if (isPageListExist) {
    ...
    console.log("tableStructure()[listName] is ", tableStructure[listName]);
    let columnArray = constructDataTable(tablesData[listName]);
