...
const startProgram = async () => {
  //generate navbar
  const navbar = Arraydocument.getElementById("navbar");
  navbar.innerHTML = nav;
  let arrayOfNavLinks = document.getElementsByClassName("nav-link");
  console.log("arrayOfNavLinks are ", arrayOfNavLinks);
  console.log("typeof(arrayOfNavLinks) is ", typeof arrayOfNavLinks);
  let activeLink = arrayOfNavLinks.find((link) =>
    link.href.includes(listName + ".html")
  );
