    ...
    ob.map((inner) => {
      ...
      data1.push({
        ...
        name: inner.securityCode
          ? arabicTranslation.closingPrice +
            " " +
            inner.securityName
          : arabicTranslation.closingPrice +
            " " +
            inner.sector,
        type: selectedType,
        hovertemplate: `%{x} :${arabicTranslation.date}<br>%{y} :${
          inner.securityCode
            ? arabicTranslation.closingPrice +
              " " +
              inner.securityName
      ...
      data2.push({
        ...
        hovertemplate: `%{x} :${arabicTranslation.date}<br>%{y} :${
          inner.securityCode
            ? arabicTranslation.volumeTraded + " " + inner.securityName
            : arabicTranslation.volumeTraded +
              " " +
              inner.sector
        }<br>`,
      });
      data3.push({
        ...
        name: inner.securityCode
          ...
          : arabicTranslation.valueTraded +
            ...
            inner.sector,
        type: selectedType,
        hovertemplate: `%{x} :${arabicTranslation[0].date}<br>%{y} :${
          inner.securityCode
            ? arabicTranslation.valueTraded +
              " " +
              inner.securityName
      ...
      data4.push({
        ...
        y: numberOfTrades,
        name: inner.securityCode
          ? arabicTranslation.NumberOfTrades +
            " " +
            inner.securityName
          : arabicTranslation.NumberOfTrades +
            " " +
